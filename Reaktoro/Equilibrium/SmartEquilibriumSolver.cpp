...
//     auto learn(ChemicalState& state, const real& T, const real& P, VectorConstRef be) -> EquilibriumResult
//     {
...
//     auto estimate(ChemicalState& state, const real& T, const real& P, VectorConstRef be) -> EquilibriumResult
//     {
//         if(tree.empty())
//             return {};
...
// auto SmartEquilibriumSolver::learn(ChemicalState& state, const real& T, const real& P, VectorConstRef be) -> EquilibriumResult
// {
...
// auto SmartEquilibriumSolver::estimate(ChemicalState& state, const real& T, const real& P, VectorConstRef be) -> EquilibriumResult
// {
...
// auto SmartEquilibriumSolver::solve(ChemicalState& state, const real& T, const real& P, VectorConstRef be) -> EquilibriumResult
// {
