...
auto waterThermoStateHGK(const real& T, const real& P, StateOfMatter stateofmatter) -> WaterThermoState
{
...
auto waterThermoStateWagnerPruss(const real& T, const real& P, StateOfMatter stateofmatter) -> WaterThermoState
{
...
auto waterThermoState(const real& T, const real& P, const WaterHelmholtzState& whs) -> WaterThermoState
{
	WaterThermoState wt;
